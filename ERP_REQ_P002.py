    ...
    def Cargar(self):
        try:
            ...
            if Nro_Inicial!='' and Nro_Final!='' and Fec_Inicial!='' and Fec_Final!='':
                sqlTabla="SELECT  a.Nro_Solp,a.Fecha_Solp, a.Fecha_Req_Global, c.Nom_usuario, d.Descripción_Área, SUM(b.Cant_Mat_Serv*b.Precio_ref) FROM TAB_SOLP_001_Cabecera_Solicitud_Pedido a LEFT JOIN TAB_SOLP_002_Detalle_Solicitud_Pedido b ON b.Cod_Soc=a.Cod_Soc AND b.Año=a.Año AND b.Nro_Solp=a.Nro_Solp AND b.Estado_Item!='4' LEFT JOIN TAB_SOC_005_Usuarios c ON a.Cod_Soc=c.Cod_Soc AND a.Solicita_Solp=c.Cod_usuario LEFT JOIN TAB_SOC_010_Áreas_de_la_empresa d ON a.Area_Solp=d.Cod_Área WHERE a.Cod_Soc='%s' AND a.Año='%s' AND a.Tipo_solp='%s' AND a.Estado_Solp='3' AND a.Nro_Solp >='%s' AND a.Nro_Solp<='%s'AND a.Fecha_Solp>='%s' AND a.Fecha_Solp<='%s' GROUP BY a.Cod_Soc, a.Año, a.Nro_Solp" %(Cod_Soc,Año,Tipo_Solp,Nro_Inicial,Nro_Final,Fec_Inicial,Fec_Final)

            elif Nro_Inicial!='' and Nro_Final!='' and Fec_Inicial!='' and Fec_Final=='':
                sqlTabla="SELECT  a.Nro_Solp,a.Fecha_Solp, a.Fecha_Req_Global, c.Nom_usuario, d.Descripción_Área, SUM(b.Cant_Mat_Serv*b.Precio_ref) FROM TAB_SOLP_001_Cabecera_Solicitud_Pedido a LEFT JOIN TAB_SOLP_002_Detalle_Solicitud_Pedido b ON b.Cod_Soc=a.Cod_Soc AND b.Año=a.Año AND b.Nro_Solp=a.Nro_Solp AND b.Estado_Item!='4' LEFT JOIN TAB_SOC_005_Usuarios c ON a.Cod_Soc=c.Cod_Soc AND a.Solicita_Solp=c.Cod_usuario LEFT JOIN TAB_SOC_010_Áreas_de_la_empresa d ON a.Area_Solp=d.Cod_Área WHERE a.Cod_Soc='%s' AND a.Año='%s' AND a.Tipo_solp='%s' AND a.Estado_Solp='3' AND a.Nro_Solp >='%s' AND a.Nro_Solp<='%s'AND a.Fecha_Solp>='%s' GROUP BY a.Cod_Soc, a.Año, a.Nro_Solp" %(Cod_Soc,Año,Tipo_Solp,Nro_Inicial,Nro_Final,Fec_Inicial)

            elif Nro_Inicial!='' and Nro_Final!='' and Fec_Inicial=='' and Fec_Final=='':
                sqlTabla="SELECT  a.Nro_Solp,a.Fecha_Solp, a.Fecha_Req_Global, c.Nom_usuario, d.Descripción_Área, SUM(b.Cant_Mat_Serv*b.Precio_ref) FROM TAB_SOLP_001_Cabecera_Solicitud_Pedido a LEFT JOIN TAB_SOLP_002_Detalle_Solicitud_Pedido b ON b.Cod_Soc=a.Cod_Soc AND b.Año=a.Año AND b.Nro_Solp=a.Nro_Solp AND b.Estado_Item!='4' LEFT JOIN TAB_SOC_005_Usuarios c ON a.Cod_Soc=c.Cod_Soc AND a.Solicita_Solp=c.Cod_usuario LEFT JOIN TAB_SOC_010_Áreas_de_la_empresa d ON a.Area_Solp=d.Cod_Área WHERE a.Cod_Soc='%s' AND a.Año='%s' AND a.Tipo_solp='%s' AND a.Estado_Solp='3' AND a.Nro_Solp >='%s' AND a.Nro_Solp<='%s' GROUP BY a.Cod_Soc, a.Año, a.Nro_Solp" %(Cod_Soc,Año,Tipo_Solp,Nro_Inicial,Nro_Final)

            elif Nro_Inicial!='' and Nro_Final=='' and Fec_Inicial=='' and Fec_Final=='':
                sqlTabla="SELECT  a.Nro_Solp,a.Fecha_Solp, a.Fecha_Req_Global, c.Nom_usuario, d.Descripción_Área, SUM(b.Cant_Mat_Serv*b.Precio_ref) FROM TAB_SOLP_001_Cabecera_Solicitud_Pedido a LEFT JOIN TAB_SOLP_002_Detalle_Solicitud_Pedido b ON b.Cod_Soc=a.Cod_Soc AND b.Año=a.Año AND b.Nro_Solp=a.Nro_Solp AND b.Estado_Item!='4' LEFT JOIN TAB_SOC_005_Usuarios c ON a.Cod_Soc=c.Cod_Soc AND a.Solicita_Solp=c.Cod_usuario LEFT JOIN TAB_SOC_010_Áreas_de_la_empresa d ON a.Area_Solp=d.Cod_Área WHERE a.Cod_Soc='%s' AND a.Año='%s' AND a.Tipo_solp='%s' AND a.Estado_Solp='3' AND a.Nro_Solp >='%s' GROUP BY a.Cod_Soc, a.Año, a.Nro_Solp" %(Cod_Soc,Año,Tipo_Solp,Nro_Inicial)

            elif Nro_Inicial!='' and Nro_Final=='' and Fec_Inicial!='' and Fec_Final=='':
                sqlTabla="SELECT  a.Nro_Solp,a.Fecha_Solp, a.Fecha_Req_Global, c.Nom_usuario, d.Descripción_Área, SUM(b.Cant_Mat_Serv*b.Precio_ref) FROM TAB_SOLP_001_Cabecera_Solicitud_Pedido a LEFT JOIN TAB_SOLP_002_Detalle_Solicitud_Pedido b ON b.Cod_Soc=a.Cod_Soc AND b.Año=a.Año AND b.Nro_Solp=a.Nro_Solp AND b.Estado_Item!='4' LEFT JOIN TAB_SOC_005_Usuarios c ON a.Cod_Soc=c.Cod_Soc AND a.Solicita_Solp=c.Cod_usuario LEFT JOIN TAB_SOC_010_Áreas_de_la_empresa d ON a.Area_Solp=d.Cod_Área WHERE a.Cod_Soc='%s' AND a.Año='%s' AND a.Tipo_solp='%s' AND a.Estado_Solp='3' AND a.Nro_Solp >='%s' AND a.Fecha_Solp>='%s' GROUP BY a.Cod_Soc, a.Año, a.Nro_Solp" %(Cod_Soc,Año,Tipo_Solp,Nro_Inicial,Fec_Inicial)

            elif Fec_Inicial!='' and Fec_Final!='' and Nro_Inicial!='' and Nro_Final=='':
                sqlTabla="SELECT  a.Nro_Solp,a.Fecha_Solp, a.Fecha_Req_Global, c.Nom_usuario, d.Descripción_Área, SUM(b.Cant_Mat_Serv*b.Precio_ref) FROM TAB_SOLP_001_Cabecera_Solicitud_Pedido a LEFT JOIN TAB_SOLP_002_Detalle_Solicitud_Pedido b ON b.Cod_Soc=a.Cod_Soc AND b.Año=a.Año AND b.Nro_Solp=a.Nro_Solp AND b.Estado_Item!='4' LEFT JOIN TAB_SOC_005_Usuarios c ON a.Cod_Soc=c.Cod_Soc AND a.Solicita_Solp=c.Cod_usuario LEFT JOIN TAB_SOC_010_Áreas_de_la_empresa d ON a.Area_Solp=d.Cod_Área WHERE a.Cod_Soc='%s' AND a.Año='%s' AND a.Tipo_solp='%s' AND a.Estado_Solp='3' AND a.Nro_Solp >='%s' AND a.Fecha_Solp>='%s' AND a.Fecha_Solp<='%s' GROUP BY a.Cod_Soc, a.Año, a.Nro_Solp" %(Cod_Soc,Año,Tipo_Solp,Nro_Inicial,Fec_Inicial,Fec_Final)

            elif Fec_Inicial!='' and Fec_Final!='' and Nro_Inicial=='' and Nro_Final=='':
                sqlTabla="SELECT  a.Nro_Solp,a.Fecha_Solp, a.Fecha_Req_Global, c.Nom_usuario, d.Descripción_Área, SUM(b.Cant_Mat_Serv*b.Precio_ref) FROM TAB_SOLP_001_Cabecera_Solicitud_Pedido a LEFT JOIN TAB_SOLP_002_Detalle_Solicitud_Pedido b ON b.Cod_Soc=a.Cod_Soc AND b.Año=a.Año AND b.Nro_Solp=a.Nro_Solp AND b.Estado_Item!='4' LEFT JOIN TAB_SOC_005_Usuarios c ON a.Cod_Soc=c.Cod_Soc AND a.Solicita_Solp=c.Cod_usuario LEFT JOIN TAB_SOC_010_Áreas_de_la_empresa d ON a.Area_Solp=d.Cod_Área WHERE a.Cod_Soc='%s' AND a.Año='%s' AND a.Tipo_solp='%s' AND a.Estado_Solp='3' AND a.Fecha_Solp>='%s' AND a.Fecha_Solp<='%s' GROUP BY a.Cod_Soc, a.Año, a.Nro_Solp" %(Cod_Soc,Año,Tipo_Solp,Fec_Inicial,Fec_Final)

            elif Fec_Inicial!='' and Fec_Final=='' and Nro_Inicial=='' and Nro_Final=='':
                sqlTabla="SELECT  a.Nro_Solp,a.Fecha_Solp, a.Fecha_Req_Global, c.Nom_usuario, d.Descripción_Área, SUM(b.Cant_Mat_Serv*b.Precio_ref) FROM TAB_SOLP_001_Cabecera_Solicitud_Pedido a LEFT JOIN TAB_SOLP_002_Detalle_Solicitud_Pedido b ON b.Cod_Soc=a.Cod_Soc AND b.Año=a.Año AND b.Nro_Solp=a.Nro_Solp AND b.Estado_Item!='4' LEFT JOIN TAB_SOC_005_Usuarios c ON a.Cod_Soc=c.Cod_Soc AND a.Solicita_Solp=c.Cod_usuario LEFT JOIN TAB_SOC_010_Áreas_de_la_empresa d ON a.Area_Solp=d.Cod_Área WHERE a.Cod_Soc='%s' AND a.Año='%s' AND a.Tipo_solp='%s' AND a.Estado_Solp='3' AND a.Fecha_Solp>='%s' GROUP BY a.Cod_Soc, a.Año, a.Nro_Solp" %(Cod_Soc,Año,Tipo_Solp,Fec_Inicial)

            elif Nro_Inicial=='' and Nro_Final=='' and Fec_Inicial=='' and Fec_Final=='':
                sqlTabla="SELECT  a.Nro_Solp,a.Fecha_Solp, a.Fecha_Req_Global, c.Nom_usuario, d.Descripción_Área, SUM(b.Cant_Mat_Serv*b.Precio_ref) FROM TAB_SOLP_001_Cabecera_Solicitud_Pedido a LEFT JOIN TAB_SOLP_002_Detalle_Solicitud_Pedido b ON b.Cod_Soc=a.Cod_Soc AND b.Año=a.Año AND b.Nro_Solp=a.Nro_Solp AND b.Estado_Item!='4' LEFT JOIN TAB_SOC_005_Usuarios c ON a.Cod_Soc=c.Cod_Soc AND a.Solicita_Solp=c.Cod_usuario LEFT JOIN TAB_SOC_010_Áreas_de_la_empresa d ON a.Area_Solp=d.Cod_Área WHERE a.Cod_Soc='%s' AND a.Año='%s' AND a.Tipo_solp='%s' AND a.Estado_Solp='3' GROUP BY a.Cod_Soc, a.Año, a.Nro_Solp" %(Cod_Soc,Año,Tipo_Solp)
